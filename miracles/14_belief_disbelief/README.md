...
| "Why these rules?"           | Rules DESCRIBE data (specific noun forms), don't filter for results.                          |
...
| "Find this in any text!"     | Challenge accepted. Try Bible/Torah. THREE exact ratios (5:3, 9:8, 5:4) from belief concepts. |
