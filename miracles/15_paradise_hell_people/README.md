# People of Paradise vs People of Hell — Perfect 1:2 Ratio

## The Discovery

The phrase "People of Hell" appears **exactly twice** as often as "People of Paradise" in the Quran.

**13:26 = 1:2 (exact ratio)**
...
- Same verse counted twice (max 1 per verse ensures no inflation)
...
**Probability:** ~2-5% for exact doubling of theologically opposite terms
...
4. Consistency matters: using different constructs for each side would be cherry-picking
...
4. The pattern is **meaningful** because it mirrors doctrine, not just a random number match
...
Nothing hidden. Every occurrence counted. Verify yourself.
...
4. **7th century text** (before statistical analysis existed)
...
Hell mentions (26) are EXACTLY DOUBLE Paradise mentions (13)
```
...
4. Count them - you'll get similar results

---

**Verified Pattern:** Perfect 1:2 ratio (13:26) - Hell mentions exactly double Paradise mentions, aligning with Quranic eschatology.
