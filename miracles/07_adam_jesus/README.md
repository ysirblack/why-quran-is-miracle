...
| "Why these rules?"           | Rules DESCRIBE data (proper names only), don't filter for results.              |
...
| "Find this in any text!"     | Challenge accepted. Try Bible/Torah. The QURAN ITSELF pairs Adam/Jesus in 3:59. |
